...
pokemon2.tipo = "agua"
console.log ("a) Crie uma cópia do objeto, acima, mantendo a estrutura, mas trocando **`nome`** por “Squirtle” e **`tipo`** por “Água”",pokemon2)
...
console.log("objeto1",pokemon1)
console.log("objeto2",pokemon2)
